...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_pinyin__ = __webpack_require__(228);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    countPage++;
    if (countPage < 2) {
      this.$http.get('./static/city.json').then(function (response) {
        var cityList = response.body.provinces;
        for (var i in cityList) {
          cityLists = cityList[i].citys;
          for (var j in cityLists) {
            cityNames.push(cityLists[j].citysName);
          }
        }
        cityNamesFilter = cityNames;
        _this2.cityFilter(_this2.citySearch);
        _this2.someData = response.data.body;
      }, function (response) {});
    }
  },
  mounted: function mounted() {},
  methods: {
    buildLetter: function buildLetter() {
      letter = [];
      for (var i = 0; i < 26; i++) {
        var obj = {};
    ...
    buildItem: function buildItem(cityNamesFilter) {
      this.buildLetter();
      var _this = this;
      for (var i = 0; i < 26; i++) {
        letter[i].citylist = [];
      }
      for (var _i = 0; _i < cityNamesFilter.length; _i++) {
        var _index = Number(_this.getFirstLetter(cityNamesFilter[_i]).charCodeAt() - 65);
        if (_index >= 0 && _index < 26) {
          letter[_index].citylist.push(cityNamesFilter[_i]);
        }
      }
    ...
    cityFilter: function cityFilter(city) {
      var showCityListTemp = void 0;
      ...
      if (showCity.length === 0) {
        var _showCityContent = document.getElementById('showCityContent');
  ...
  watch: {
    citySearch: function citySearch(newCitySearch) {
...
// module
exports.push([module.i, "*{margin:0;padding:0}#city{position:relative}.letter-item>div:first-child{font-size:16px;line-height:2em;background:#eee;margin-bottom:2px}.letter-item>div{padding-right:10%;padding-left:10%;border-bottom:1px solid #f2f2f2}.letter-aside{position:fixed;right:10px;top:30px}.letter-aside ul{list-style:none;line-height:1.4em;font-size:14px;color:#aaa}#tip{position:fixed;left:0;right:0;top:0;bottom:0;margin:auto;border:1px solid #333;width:100px;height:100px;z-index:10;text-align:center;line-height:100px;font-size:50px;opacity:0}.tipAppear{-webkit-animation:appearTip 1 linear .5s;animation:appearTip 1 linear .5s}@-webkit-keyframes appearTip{0%{opacity:1}80%{opacity:.5}to{opacity:0}}@keyframes appearTip{0%{opacity:1}80%{opacity:.5}to{opacity:0}}.search-city{text-align:center;padding:5px 0}.search-city input{line-height:24px;border-radius:5px;outline:none}.tipShow{text-align:center;line-height:60px;font-size:16px;color:#bbb}", "", {"version":3,"sources":["E:/github托管项目/vue2.0-demos/src/components/city.vue"],"names":[],"mappings":"AACA,EACE,SAAU,AACV,SAAW,CACZ,AACD,MACE,iBAAmB,CACpB,AACD,6BACE,eAAgB,AAChB,gBAAiB,AACjB,gBAAiB,AACjB,iBAAmB,CACpB,AACD,iBACE,kBAAmB,AACnB,iBAAkB,AAClB,+BAAiC,CAClC,AACD,cACE,eAAgB,AAChB,WAAY,AACZ,QAAU,CACX,AACD,iBACE,gBAAiB,AACjB,kBAAmB,AACnB,eAAgB,AAChB,UAAY,CACb,AACD,KACE,eAAgB,AAChB,OAAQ,AACR,QAAS,AACT,MAAO,AACP,SAAU,AACV,YAAa,AACb,sBAA0B,AAC1B,YAAa,AACb,aAAc,AACd,WAAY,AACZ,kBAAmB,AACnB,kBAAmB,AACnB,eAAgB,AAChB,SAAW,CACZ,AACD,WACE,yCAA2C,AACnC,gCAAmC,CAC5C,AACD,6BACA,GACI,SAAW,CACd,AACD,IACI,UAAa,CAChB,AACD,GACI,SAAW,CACd,CACA,AACD,qBACA,GACI,SAAW,CACd,AACD,IACI,UAAa,CAChB,AACD,GACI,SAAW,CACd,CACA,AACD,aACE,kBAAmB,AACnB,aAAe,CAChB,AACD,mBACE,iBAAkB,AAClB,kBAAmB,AACnB,YAAc,CACf,AACD,SACE,kBAAmB,AACnB,iBAAkB,AAClB,eAAgB,AAChB,UAAe,CAChB","file":"city.vue","sourcesContent":["\n* {\n  margin: 0;\n  padding: 0;\n}\n#city {\n  position: relative;\n}\n.letter-item > div:first-child {\n  font-size: 16px;\n  line-height: 2em;\n  background: #eee;\n  margin-bottom: 2px;\n}\n.letter-item > div {\n  padding-right: 10%;\n  padding-left: 10%;\n  border-bottom: 1px solid #f2f2f2;\n}\n.letter-aside {\n  position: fixed;\n  right: 10px;\n  top: 30px;\n}\n.letter-aside ul {\n  list-style: none;\n  line-height: 1.4em;\n  font-size: 14px;\n  color: #aaa;\n}\n#tip {\n  position: fixed;\n  left: 0;\n  right: 0;\n  top: 0;\n  bottom: 0;\n  margin: auto;\n  border: 1px solid #333333;\n  width: 100px;\n  height: 100px;\n  z-index: 10;\n  text-align: center;\n  line-height: 100px;\n  font-size: 50px;\n  opacity: 0;\n}\n.tipAppear {\n  -webkit-animation: appearTip 1 linear 0.5s;\n          animation: appearTip 1 linear 0.5s;\n}\n@-webkit-keyframes appearTip {\n0% {\n    opacity: 1;\n}\n80% {\n    opacity: 0.5;\n}\n100% {\n    opacity: 0;\n}\n}\n@keyframes appearTip {\n0% {\n    opacity: 1;\n}\n80% {\n    opacity: 0.5;\n}\n100% {\n    opacity: 0;\n}\n}\n.search-city {\n  text-align: center;\n  padding: 5px 0;\n}\n.search-city input {\n  line-height: 24px;\n  border-radius: 5px;\n  outline: none;\n}\n.tipShow {\n  text-align: center;\n  line-height: 60px;\n  font-size: 16px;\n  color: #bbbbbb;\n}\n"],"sourceRoot":""}]);
...
var update = __webpack_require__(91)("703ec205", content, true);
...
const assign = __webpack_require__(224);
...
// 带音标字符。
const PHONETIC_SYMBOL = __webpack_require__(226);
...
const PINYIN_DICT = buildPinyinCache(__webpack_require__(225));
const Pinyin = __webpack_require__(227);
...
//# sourceMappingURL=2.4650fb3fc6ed37cea86a.js.map